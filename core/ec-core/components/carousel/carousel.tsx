  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span className="no-wrap flex items-center gap-6">
          <Button
            aria-label="Previous products"
            className={cn(
              'bg-bg-light h-10 w-10 p-0',
          ...
          <span>
            {selectedSnapIndex + 1} / {groupedProducts.length}
          </span>

          <Button
            aria-label="Next products"
            className={cn('h-10 w-10 p-0', api?.scrollSnapList().length === 1 && 'hidden')}
